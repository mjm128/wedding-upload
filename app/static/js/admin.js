...
async function action(id, act) {
    if (act === 'delete' && !confirm('Are you sure you want to delete this?')) return;
    ...
    if (res.ok) {
        // Refresh grid
        // Simple way: clear and reload. Better way: update DOM.
        // Let's clear and reload for simplicity
